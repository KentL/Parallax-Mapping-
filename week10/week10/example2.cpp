...
//
// Example 2: Diffuse lighting on cube, with 2 lights
//========================================================================
...
void InitExample2()
{
    ...
    g_pProgram = wolf::ProgramManager::CreateProgram("data/week10/example2.vsh", "data/week10/example2.fsh");
...
void RenderExample2()
{
    ...
    g_pProgram->SetUniform("Light1Dir", -glm::vec3(0.0f,0.0f,-1.0f));
    g_pProgram->SetUniform("Light1Color", glm::vec4(1.0f,0.0f,0.0f,1.0f));
    g_pProgram->SetUniform("Light2Dir", -glm::vec3(-1.0f,0.0f,0.0f));
    g_pProgram->SetUniform("Light2Color", glm::vec4(0.0f,1.0f,0.0f,1.0f));
