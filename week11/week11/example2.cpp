...
void InitExample2()
{
    ...
    g_pMat->SetProgram("data/week11/point_light.vsh", "data/week11/point_light.fsh");
	...
	g_light.m_diffuse = wolf::Color4(1,0,0,1);
	g_light.m_ambient = wolf::Color4(0.1,0.1,0.1,1);
	g_light.m_specular = wolf::Color4(1,1,1,1);
	g_light.m_vPosition = glm::vec3(0.0f,50.0f,100.0f);
