...
//
// Example 5: Normal mapping with directional light, on a cube
//========================================================================
...
void InitExample5()
{
    ...
    g_pVB = wolf::BufferManager::CreateVertexBuffer(g_aVertices, sizeof(Vertex)*6*3*2);
...
void RenderExample5()
{
	...
	mWorld = mWorld * glm::rotate(s_fRot, 1.0f, 0.0f, 1.0f);
	s_fRot += 1.0f * s_fSpeed;
